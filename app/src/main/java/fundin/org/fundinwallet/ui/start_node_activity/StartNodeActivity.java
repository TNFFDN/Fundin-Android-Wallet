...
import global.FdntrumGlobalData;
...
public class StartNodeActivity extends BaseActivity {
    ...
    private static final List<FdntrumPeerData> trustedNodes = FdntrumGlobalData.listTrustedHosts();
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        openDialog.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DialogBuilder dialogBuilder = DialogsUtil.buildtrustedNodeDialog(StartNodeActivity.this, new DialogsUtil.TrustedNodeDialogListener() {
                    @Override
                    public void onNodeSelected(FdntrumPeerData fdntrumPeerData) {
                        if(!trustedNodes.contains(fdntrumPeerData)) {
                            dropdown.setAdapter(null);
                            adapter.clear();
                            hosts = new ArrayList<String>();
                            trustedNodes.add(fdntrumPeerData);
                            for (FdntrumPeerData trustedNode : trustedNodes) {
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FdntrumPeerData selectedNode = trustedNodes.get(selected);
        ...
        FdntrumPeerData fdntrumPeer = fundinApplication.getAppConf().getTrustedNode();
        ...
        for (int i=0;i<trustedNodes.size();i++){
            FdntrumPeerData trustedNode = trustedNodes.get(i);
