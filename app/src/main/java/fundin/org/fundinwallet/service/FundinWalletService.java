...
public class FundinWalletService extends Service{
    ...
    //private FdntrumPeergroup fdntrumPeergroup;
    ...
    public void onCreate() {
        ...
        try {
            ...
            /*fdntrumPeergroup = new FdntrumPeergroup(fundinApplication.getNetworkConf());
            fdntrumPeergroup.addAddressListener(addressListener);
            module.setFdntrumPeergroup(fdntrumPeergroup);*/
