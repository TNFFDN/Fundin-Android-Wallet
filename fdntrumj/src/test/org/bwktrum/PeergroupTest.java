...
public class PeergroupTest {
    ...
    public void connectBwktrumPeergroupTest() throws IOException, ConnectionFailureException, InterruptedException {
        ...
        BwktrumPeergroup fdntrumPeergroup = new BwktrumPeergroup(networkConf,walletManager,addressStore);
        ...
        //assert fdntrumPeergroup.isRunning():"BwktrumPeergroup is not running..";
    }
