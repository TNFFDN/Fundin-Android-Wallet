...
public class BwktrumPeergroup implements PeerListener, PeerDataListener {
    ...
    @Override
    public void onConnected(BwktrumPeer fdntrumPeer) {
        try {
    ...
    @Override
    public void onDisconnected(BwktrumPeer fdntrumPeer) {

    }

    @Override
    public void onExceptionCaught(BwktrumPeer fdntrumPeer, Exception e) {
    ...
    @Override
    public void onSubscribedAddressChange(BwktrumPeer fdntrumPeer, String address, String status) {
        try {
    ...
    @Override
    public void onListUnpent(BwktrumPeer fdntrumPeer,String address, List<Unspent> unspents) {
    ...
    @Override
    public void onBalanceReceive(BwktrumPeer fdntrumPeer, String address, long confirmed, long unconfirmed) {
        try {
            if (fdntrumPeer == trustedPeer) {
    ...
    @Override
    public void onGetHistory(BwktrumPeer fdntrumPeer, StatusHistory statusHistory) {
        try {
