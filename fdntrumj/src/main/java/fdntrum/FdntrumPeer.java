...
import fdntrum.messages.GetHeader;
import fdntrum.messages.GetHistoryMsg;
import fdntrum.messages.GetTxMsg;
import fdntrum.messages.ListUnspentMsg;
...
public class FdntrumPeer implements IoHandler{

    private final Logger log;

    /** Peer data */
    private FdntrumPeerData peerData;
    /**  */
    ...
    public FdntrumPeer(FdntrumPeerData peerData,IoManager ioManager,VersionMsg versionMsg) {
        this.peerData = peerData;
        this.ioManager = ioManager;
        this.versionMsg = versionMsg;
        this.log = LoggerFactory.getLogger(FdntrumPeer.class.getName()+"-"+peerData.getHost());
    }
    ...
    public void connect() throws ConnectionFailureException, InterruptedException {
        if (isInitilizing.compareAndSet(false,true) && !isRunning.get()) {
            ...
            throw new IllegalStateException("FdntrumPeer already initializing");
        }
    }
    ...
    public FdntrumPeerData getPeerData() {
        return peerData;
    }
