...
public class NetworkConf {
    ...
    private static final String CLIENT_NAME = "fundin_mobile";
    ...
    private FdntrumPeerData trustedHost;
    ...
    public FdntrumPeerData getTrustedServer() {
        return trustedHost;
    }

    public void setTrustedServer(FdntrumPeerData fdntrumPeerData) {
        this.trustedHost = fdntrumPeerData;
